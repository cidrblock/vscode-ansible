...
const styles: Record<string, React.CSSProperties> = {
    input: { flex: 1, padding: '5px 8px', background: 'var(--navita-bg-tertiary)', border: '1px solid var(--navita-border)', borderRadius: 'var(--navita-radius-sm)', color: 'var(--navita-text-primary)', fontSize: 'var(--navita-font-size-sm)', outline: 'none' },
    searchBtn: { padding: '5px 10px', background: 'var(--navita-bg-active)', borderRadius: 'var(--navita-radius-sm)', fontSize: 'var(--navita-font-size-sm)', color: 'var(--navita-text-primary)', fontWeight: 500 },
    ...
    detailMeta: { fontSize: 'var(--navita-font-size-sm)', color: 'var(--navita-text-tertiary)' },
    installBtn: { alignSelf: 'flex-start', padding: '7px 20px', background: 'var(--navita-text-primary)', color: 'var(--navita-text-inverse)', borderRadius: 'var(--navita-radius-sm)', fontWeight: 500, fontSize: 'var(--navita-font-size-sm)' },
