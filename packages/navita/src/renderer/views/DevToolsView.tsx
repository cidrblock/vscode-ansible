...
const styles: Record<string, React.CSSProperties> = {
    ...
    emptyHint: { padding: '0 12px', color: 'var(--navita-text-tertiary)', fontSize: 'var(--navita-font-size-xs)' },
    emptyCmd: {
        margin: '0 12px', padding: '6px 10px', background: 'var(--navita-bg-tertiary)', borderRadius: 'var(--navita-radius-sm)',
        fontFamily: 'var(--navita-font-mono)', fontSize: 'var(--navita-font-size-xs)', color: 'var(--navita-text-primary)',
        userSelect: 'text',
    },
    ...
    detailDesc: { fontSize: 'var(--navita-font-size-sm)', color: 'var(--navita-text-secondary)', lineHeight: 1.6 },
};
