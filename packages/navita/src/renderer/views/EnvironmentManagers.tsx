...
const styles: Record<string, React.CSSProperties> = {
    ...
    hint: { padding: '0 12px', color: 'var(--navita-text-tertiary)', fontSize: 'var(--navita-font-size-xs)', lineHeight: 1.5 },
    rescanBtn: { margin: '4px 12px', alignSelf: 'flex-start', padding: '5px 14px', background: 'var(--navita-bg-active)', borderRadius: 'var(--navita-radius-sm)', fontSize: 'var(--navita-font-size-xs)', color: 'var(--navita-text-primary)', fontWeight: 500 },
    groupHeader: { padding: '6px 12px', fontSize: 'var(--navita-font-size-xs)', color: 'var(--navita-text-tertiary)', textTransform: 'uppercase' as const, letterSpacing: '0.5px', borderBottom: '1px solid var(--navita-border)' },
    ...
    fieldLabel: { fontSize: 'var(--navita-font-size-xs)', color: 'var(--navita-text-tertiary)', fontWeight: 500 },
    fieldValue: { fontSize: 'var(--navita-font-size-sm)', color: 'var(--navita-text-primary)', fontFamily: 'var(--navita-font-mono)', wordBreak: 'break-all' as const },
    selectBtn: { alignSelf: 'flex-start', padding: '7px 20px', background: 'var(--navita-text-primary)', color: 'var(--navita-text-inverse)', borderRadius: 'var(--navita-radius-sm)', fontWeight: 500, fontSize: 'var(--navita-font-size-sm)' },
    success: { fontSize: 'var(--navita-font-size-sm)', color: 'var(--navita-success)' },
};
