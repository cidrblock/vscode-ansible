...
const styles: Record<string, React.CSSProperties> = {
    ...
    detailTitle: { fontFamily: 'var(--navita-font-mono)', fontSize: 'var(--navita-font-size-md)', fontWeight: 600, wordBreak: 'break-all' as const },
    ...
    fieldValue: { fontSize: 'var(--navita-font-size-sm)', color: 'var(--navita-text-primary)' },
};
