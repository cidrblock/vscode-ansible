...
function registerSettingsHandlers(): void {
    ipcMain.handle(IPC_CHANNELS.GET_SETTINGS, (): StudioSettings => loadSettings());
    ipcMain.handle(IPC_CHANNELS.SAVE_SETTINGS, (_event, settings: StudioSettings): void => {
...
const PROJECTS_FILE = path.join(os.homedir(), '.config', 'ansible-studio', 'projects.json');
