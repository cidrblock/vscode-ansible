...
const styles: Record<string, React.CSSProperties> = {
    desc: { fontSize: 'var(--studio-font-size-xs)', color: 'var(--studio-text-tertiary)' },
    ...
    detailDesc: { fontSize: 'var(--studio-font-size-sm)', color: 'var(--studio-text-secondary)' },
    form: { display: 'flex', flexDirection: 'column', gap: '8px' },
    field: { display: 'flex', flexDirection: 'column', gap: '3px' },
    fieldLabel: { fontSize: 'var(--studio-font-size-xs)', fontWeight: 500, color: 'var(--studio-text-secondary)' },
    fieldInput: { padding: '5px 8px', background: 'var(--studio-bg-primary)', border: '1px solid var(--studio-border)', borderRadius: 'var(--studio-radius-sm)', fontSize: 'var(--studio-font-size-sm)', color: 'var(--studio-text-primary)', outline: 'none' },
    runBtn: { alignSelf: 'flex-start', padding: '6px 16px', background: 'var(--studio-text-primary)', color: 'var(--studio-text-inverse)', borderRadius: 'var(--studio-radius-sm)', fontWeight: 500, fontSize: 'var(--studio-font-size-sm)' },
    output: { padding: '8px', background: 'var(--studio-bg-primary)', borderRadius: 'var(--studio-radius-sm)', fontSize: 'var(--studio-font-size-xs)', fontFamily: 'var(--studio-font-mono)', color: 'var(--studio-text-secondary)', whiteSpace: 'pre-wrap' as const, maxHeight: '250px', overflowY: 'auto' as const, userSelect: 'text' },
};
