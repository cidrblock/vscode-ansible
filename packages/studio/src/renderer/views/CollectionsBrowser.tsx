...
const styles: Record<string, React.CSSProperties> = {
    searchHeader: { padding: '6px 12px', fontSize: 'var(--studio-font-size-xs)', color: 'var(--studio-text-tertiary)', textTransform: 'uppercase' as const, letterSpacing: '0.5px', borderBottom: '1px solid var(--studio-border)' },
    error: { padding: '8px 12px', fontSize: 'var(--studio-font-size-xs)', color: 'var(--studio-error)' },
    collectionHeader: { padding: '10px 12px 4px', borderBottom: '1px solid var(--studio-border)' },
    collectionTitle: { fontFamily: 'var(--studio-font-mono)', fontSize: 'var(--studio-font-size-sm)', fontWeight: 600 },
};
